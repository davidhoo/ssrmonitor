...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.ssrmonitor.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".ssrmonitor" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".ssrmonitor")
	}
